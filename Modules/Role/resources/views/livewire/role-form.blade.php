<div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 pb-12">
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.role.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                Hủy bỏ
            </a>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sticky top-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="name" class="block w-full rounded-md border-0 py-2.5 pl-10 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="VD: Sale Manager">
