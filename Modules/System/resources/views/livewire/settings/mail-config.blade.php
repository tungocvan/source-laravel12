    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="email" wire:model="form.MAIL_FROM_ADDRESS" placeholder="name@example.com" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary/20 outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="form.MAIL_FROM_NAME" placeholder="Tên website hoặc doanh nghiệp" class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-primary/20 outline-none">
